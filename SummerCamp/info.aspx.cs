...
namespace SummerCamp
{
    public partial class info : System.Web.UI.Page
    {
        ...
        protected void GetTaskContent(int ida)
        {
            ...
            string sqlstr = "SELECT * FROM [db_forminf].[dbo].[product] where shop_id='S0000081' and  (Is_inner ='Z' OR Is_inner = 'N') AND Is_open = 'Y'  and id =" + ida;
 ...
 on a.merchantSeq=b.merchantSeq  where a.id is not null  and a.refundtime is null and  a.remark='订单交易成功' and b.remark = '" + this.HiddenField7.Value.Trim() + "'";
            ...
            if (myViewDate1.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    //如果报名人数已满，更新关闭课程
                    string sqlstr2 = "update  [db_forminf].[dbo].[product] set Is_open = 'N' where shop_id='S0000081' and  product_id = '" + this.HiddenField7.Value.Trim() + "'";
