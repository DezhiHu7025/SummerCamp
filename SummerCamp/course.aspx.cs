...
namespace SummerCamp
{
 ...
 //           string sqlstr = "SELECT * FROM [db_forminf].[dbo].[product]  where shop_id='S0000081' and (Is_inner ='Z' OR Is_inner = 'N') AND Is_open = 'Y'  order by id";
 ...
 //               {
 //                   //如果报名人数已满，更新关闭课程
 //                   string sqlstr2 = "update  [db_forminf].[dbo].[product] set Is_open = 'N' where shop_id='S0000081' and  product_id = '" + myRow["product_id"].ToString().Trim() + "'";
